...
- **24/7 / unattended mode:** deliberately out of scope; would change the storage and supervision story entirely.
- **Calibration:** hot/cold or Y-factor calibration to real temperature units — an ObservationType + math module later; v1 reports relative power/SNR only.
